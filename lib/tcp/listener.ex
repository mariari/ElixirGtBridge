defmodule Tcp.Listener do
  ...
  def init(args) do
    ...
    args = Keyword.validate!(args, [:host, :port])
  ...
  # """
  @spec wait_for_accept(:inet.socket()) :: {:ok, :accepted} | {:error, :failed_to_accept}
  defp wait_for_accept(socket) do
    case :gen_tcp.accept(socket) do
      # a new connection was accepted
      {:ok, socket} ->
        # create a new listener process for the next connection
        {:ok, pid} = create_new_connection(socket)
  ...
  # """
  @spec create_new_connection(:inet.socket()) :: {:ok, pid()} | {:error, any()}
